...
/* funzione per intercettare il keypress all'interno dello WYSIWYG HTML */
...
function initScreenshotsSameExension() {
    chrome.runtime.sendMessage("eakfjnpihbkoohjbelkfjcdlkdhfeadb","sameGetScreenshots");
}
